...
const routes: Routes = [
  ...
  { path: 'editarConsulta/:auth', component: EditarConsultaComponent },
  { path: 'editarTratamiento/:auth', component: EditarTratamientoComponent },
  { path: 'editarDiagnostico/:auth', component: EditarDiagnosticoComponent },
